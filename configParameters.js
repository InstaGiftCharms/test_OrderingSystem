    ...
    static productInfo = [
        {
            ...
            productForm: [ // Define form for Charm 1
                ...
                { type: 'textbox', id: 'txt_charmMsg', value: 'Type here', ResponsePrefix:'Keychain name of ' },
                ...
                { type: 'quantity', id: 'num_itemQuantity', value: 'Item Quantity', ResponsePrefix:'Quantity: ' }
            ]
        },
    ];
}
